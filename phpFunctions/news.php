 ...
 * @return  string
 */
function createNewsFeed ($newsClient) {
    $htmlOutput = "";

    //list of rss feeds
    $clients = [];
    $clients["tagesschau"] = array("Tagesschau", "http://www.tagesschau.de/xml/rss2", "rss");
    $clients["heise"] = array("Heise", "http://www.heise.de/rss/heise.rdf", "rss");
    ...
    switch ($clients[$newsClient][2]) {
        ...
        default:
            //not supported
            $htmlOutput .= emptyFeed("RSS not supported", true);
    ...
    foreach ($rss->item as $item) {
        ...
        */
        ...
        $htmlOutput .= "
                        <div class='article'>
                            <a href='" . $item->link . "' target='_blank' title='Link to article'>
